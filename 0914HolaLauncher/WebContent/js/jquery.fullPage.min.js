    ...
    a.fn.fullpage = function(c) {
        ...
        function J() {
            if (!c.autoScrolling || c.scrollBar) {
            	//b scroll의 위치
            	//d?
            	//e = |현재 스크롤의 높이 - fp-section부의 첫번째부분의좌표의 상단|
            	cosole.log("hi");
        ...
        function n(b) {
            ...
            if (c.autoScrolling) {
                b = window.event || b;
            	console.log("wheelDelta = "+(b.detail));
        ...
        a.fn.fullpage.moveSectionDown = function() {
            ...
            //b.length(1,0) > 다음 길이가 있으면(1, 0), c.loopBottom 마지막에서 첫페이지로 넘어가질 안넘어갈지(1, 0) continuousVertical: page가 첫페이지일때, 마지막페이지로 올라갈것인가 말것인가(1,0)
        ...
        a(document).keydown(function(b) {
            if (c.keyboardScrolling && !l && c.autoScrolling) switch (b.which) {
            	//b.which를 이용해 버튼의 keycode를 얻어냄.
            	////pageUp버튼, UpArrow버튼.
                case 38:
                case 33:
                    a.fn.fullpage.moveSectionUp();
                    break;
                ////pageDown버튼, DownArrow버튼.
                case 40:
                case 34:
